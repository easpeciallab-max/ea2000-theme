...
- **11 ก.ย. 2026 · ป้ายหัวข้อเล็กไม่มี // นำหน้าแล้ว** (v2.10.3 · เจ้าของสั่ง ดูเหมือนงานยังไม่เสร็จ) · ลูกเล่นคอมเมนต์โค้ดถือว่ายกเลิกทั้งเว็บ
- **11 ก.ย. 2026 · บาร์ล่างมือถือ: คีย์ LINE หน้าตาเหมือนคีย์อื่น ป้ายทุกคีย์สีเขียว และปุ่มเมนูไม่มีพื้นเขียว** (v2.9.1 · เจ้าของสั่ง) · คีย์ LINE ไม่ยกเจาะราง ไม่มีพื้นเขียว ไอคอนขนาดเท่าคีย์อื่น ไม่มีไฟกะพริบ · ถอด `--cap-h-line`, `--dock-ring`, `--dock-punch`, `--lift` และ `@keyframes dock-live` · คลาส `.is-action` ยังอยู่เพราะ main.js ใช้ข้ามการหาหน้าปัจจุบัน · ป้าย `.dock-label` ทุกคีย์ใช้ `--ink-accent` คีย์ของหน้าที่เปิดอยู่ยังต่างด้วยตัวคีย์ที่ยก วงเล็บ HUD ไฟชี้ตำแหน่ง และตัวหนา · ปุ่ม `.nav-toggle` พื้นและกรอบโปร่ง ขีดสีขาว 24x3 · **คีย์ LINE แบบยกและปุ่มเมนูพื้นเขียวถือว่ายกเลิก อย่าเอากลับมาโดยไม่ถามเจ้าของ**
