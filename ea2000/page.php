...
$ea2000_is_elementor = ea2000_is_elementor_page();
?>

<main id="main"<?php echo $ea2000_is_elementor ? ' class="elementor-page-shell elementor-page-shell--auto"' : ''; ?>>
	<?php if ( $ea2000_is_elementor ) : ?>
