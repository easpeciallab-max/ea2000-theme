	...
	$sections = array(
		...
		'ea2000_tests' => array(
			...
			'fields'      => array(
				...
				'tests_bt_img'      => array( 'แผง Backtest · ภาพ', 'image', 'แนะนำ 1600x900 px · ภาพประกอบต้องไม่มีตัวเลขผลลัพธ์ · ภาพรายงานใส่เมื่อมีผลจริงเท่านั้น' ),
				'tests_bt_img_mobile' => array( 'แผง Backtest · ภาพสำหรับมือถือ (ถ้ามี)', 'image', 'แนวตั้ง แนะนำ 1080x1350 px · แสดงแทนภาพหลักบนจอกว้างไม่เกิน 640 px' ),
				...
				'tests_bt_img_caption' => array( 'แผง Backtest · คำบรรยายใต้ภาพ', 'text' ),
				...
				'tests_fw_img'      => array( 'แผง Forward Test · ภาพ', 'image', 'แนะนำ 1600x900 px · ภาพประกอบต้องไม่มีตัวเลขผลลัพธ์ · ภาพบัญชีจริงใส่เมื่อมีข้อมูลจริงเท่านั้น' ),
				'tests_fw_img_mobile' => array( 'แผง Forward Test · ภาพสำหรับมือถือ (ถ้ามี)', 'image', 'แนวตั้ง แนะนำ 1080x1350 px · แสดงแทนภาพหลักบนจอกว้างไม่เกิน 640 px' ),
				...
				'tests_fw_img_caption' => array( 'แผง Forward Test · คำบรรยายใต้ภาพ', 'text' ),
		...
		'ea2000_install_home' => array(
			...
			'fields'      => array(
				...
				'install_step1_img_caption' => array( 'ขั้นที่ 1 · คำบรรยายใต้ภาพ', 'text' ),
				...
				'install_step2_img_caption' => array( 'ขั้นที่ 2 · คำบรรยายใต้ภาพ', 'text' ),
				...
				'install_step3_img_caption' => array( 'ขั้นที่ 3 · คำบรรยายใต้ภาพ', 'text' ),
		...
		'ea2000_backtest' => array(
			...
			'fields'      => array(
				...
				'backtest_img'         => array( 'ภาพประกอบหรือภาพรายงานผล Backtest', 'image', 'ภาพรายงานใส่เมื่อมีผลจริงเท่านั้น' ),
				'backtest_img_mobile'  => array( 'ภาพสำหรับมือถือ (ถ้ามี)', 'image', 'แนวตั้ง แนะนำ 1080x1350 px' ),
				'backtest_img_caption' => array( 'คำบรรยายภาพ', 'text' ),
				'backtest_img_alt'     => array( 'ข้อความแทนภาพ (Alt)', 'text' ),
				'backtest_note'        => array( 'หมายเหตุเงื่อนไขการทดสอบ', 'textarea' ),
				'backtest_disclaimer'  => array( 'Disclaimer (จำเป็น)', 'textarea' ),
				'backtest_cta_title'   => array( 'แถบ LINE ท้ายหน้า · หัวข้อ', 'text' ),
				'backtest_cta_text'    => array( 'แถบ LINE ท้ายหน้า · ข้อความ', 'text', 'ห้ามสื่อว่ามีผลทดสอบให้ขอดู จนกว่าจะมีผลจริง' ),
			),
		),
		...
		'ea2000_forward' => array(
			...
			'fields'      => array(
				...
				'forward_img'         => array( 'ภาพประกอบหรือภาพผลการทดสอบ', 'image', 'ภาพผลการทดสอบใส่เมื่อมีข้อมูลจริงเท่านั้น' ),
				'forward_img_mobile'  => array( 'ภาพสำหรับมือถือ (ถ้ามี)', 'image', 'แนวตั้ง แนะนำ 1080x1350 px' ),
				'forward_img_caption' => array( 'คำบรรยายภาพ', 'text' ),
				'forward_img_alt'     => array( 'ข้อความแทนภาพ (Alt)', 'text' ),
				...
				'forward_cta_title'   => array( 'แถบ LINE ท้ายหน้า · หัวข้อ', 'text' ),
				'forward_cta_text'    => array( 'แถบ LINE ท้ายหน้า · ข้อความ', 'text', 'ห้ามสื่อว่ามีผลทดสอบให้ติดตาม จนกว่าจะมีบัญชีทดสอบจริง' ),
			),
		),
		...
		'ea2000_links' => array(
			...
			'fields'      => array(
				...
				'links_signup_url'   => array( 'ลิงก์ปุ่มสมัคร (เว้นว่าง = แสดงปุ่ม LINE ขอลิงก์แทน · ใส่ URL เต็ม)', 'text' ),
				...
				'links_mt5_download_label'  => array( 'ข้อความปุ่มคู่มือล็อกอิน MT5', 'text' ),
				'links_mt5_download_url'    => array( 'ลิงก์ปุ่มคู่มือล็อกอิน MT5 (เว้นว่าง = ซ่อนปุ่ม)', 'text' ),
				'links_help_title' => array( 'กลุ่มติดต่อทีม (บนสุด) · หัวข้อ', 'text' ),
				'links_steps_title' => array( 'ขั้นตอนเริ่มใช้งาน · หัวข้อรวม', 'text', 'ใส่ {n} เพื่อแสดงจำนวนขั้นตอนอัตโนมัติ · ขั้นที่ไม่มีปุ่มจะถูกซ่อนและเลขเรียงใหม่' ),
				'links_pending_label' => array( 'ป้ายปุ่มที่ยังไม่มีลิงก์ (หน้าที่ยังไม่สร้าง)', 'text', 'ปุ่มที่มีข้อความแต่เว้นลิงก์ว่างจะแสดงจาง กดไม่ได้ พร้อมป้ายนี้' ),
				'links_step1_title' => array( 'ขั้นเปิดบัญชี · หัวข้อ', 'text' ),
				'links_step1_desc' => array( 'ขั้นเปิดบัญชี · คำอธิบาย', 'text' ),
				'links_step1_note' => array( 'ขั้นเปิดบัญชี · หมายเหตุเปิดเผยความเป็นพันธมิตร', 'text' ),
				'links_signup_line_label' => array( 'ขั้นเปิดบัญชี · ข้อความปุ่ม LINE เมื่อยังไม่มีลิงก์สมัคร', 'text', 'ถ้ากรอกลิงก์ปุ่มสมัครด้านบน ปุ่มนี้จะถูกแทนด้วยปุ่มสมัคร' ),
				'links_mt5_install_title' => array( 'ขั้นติดตั้ง MT5 · หัวข้อ', 'text' ),
				'links_step2_desc' => array( 'ขั้นติดตั้ง MT5 · คำอธิบาย', 'text' ),
				'links_mt5_ios_label' => array( 'ขั้นติดตั้ง MT5 · ปุ่ม iPhone', 'text' ),
				'links_mt5_ios_url' => array( 'ขั้นติดตั้ง MT5 · ลิงก์ iPhone (ว่าง = ซ่อน)', 'text' ),
				'links_mt5_android_label' => array( 'ขั้นติดตั้ง MT5 · ปุ่ม Android', 'text' ),
				'links_mt5_android_url' => array( 'ขั้นติดตั้ง MT5 · ลิงก์ Android (ว่าง = ซ่อน)', 'text' ),
				'links_mt5_windows_label' => array( 'ขั้นติดตั้ง MT5 · ปุ่ม Windows', 'text' ),
				'links_mt5_windows_url' => array( 'ขั้นติดตั้ง MT5 · ลิงก์ Windows (ว่าง = ซ่อน)', 'text' ),
				'links_mt5_macos_label' => array( 'ขั้นติดตั้ง MT5 · ปุ่ม macOS', 'text' ),
				'links_mt5_macos_url' => array( 'ขั้นติดตั้ง MT5 · ลิงก์ macOS (ว่าง = ซ่อน)', 'text' ),
				'links_step3_title' => array( 'ขั้นฝากเงิน · หัวข้อ', 'text' ),
				'links_step3_desc' => array( 'ขั้นฝากเงิน · คำอธิบาย', 'text' ),
				'links_deposit_label' => array( 'ขั้นฝากเงิน · ข้อความปุ่มหลัก', 'text' ),
				'links_deposit_url' => array( 'ขั้นฝากเงิน · ลิงก์ปุ่มหลัก (ว่าง = ซ่อน)', 'text' ),
				'links_deposit_guide_label' => array( 'ขั้นฝากเงิน · ข้อความปุ่มคู่มือ', 'text' ),
				'links_deposit_guide_url' => array( 'ขั้นฝากเงิน · ลิงก์คู่มือฝากเงิน (ว่าง = ปุ่มจาง เร็ว ๆ นี้)', 'text' ),
				'links_step4_title' => array( 'ขั้นรับไฟล์ EA · หัวข้อ', 'text' ),
				'links_step4_desc' => array( 'ขั้นรับไฟล์ EA · คำอธิบาย', 'text' ),
				'links_download_line_label' => array( 'ขั้นรับไฟล์ EA · ข้อความปุ่ม LINE เมื่อยังไม่มีลิงก์ไฟล์', 'text', 'ถ้ากรอกลิงก์การ์ดดาวน์โหลด EA ปุ่มนี้จะถูกแทนด้วยการ์ด' ),
				'links_step5_title' => array( 'ขั้นติดตั้ง EA · หัวข้อ', 'text' ),
				'links_step5_desc' => array( 'ขั้นติดตั้ง EA · คำอธิบาย', 'text' ),
				'links_step6_title' => array( 'ขั้น VPS · หัวข้อ', 'text' ),
				'links_step6_desc' => array( 'ขั้น VPS · คำอธิบาย', 'text' ),
				'links_step6_badge' => array( 'ขั้น VPS · ป้ายเล็ก (ว่าง = ซ่อน)', 'text' ),
				'links_info_title' => array( 'กลุ่มข้อมูลก่อนตัดสินใจ · หัวข้อ', 'text' ),
				'links_show_doc' => array( 'แสดงหัวข้อเนื้อหายาวแบบเดิมใต้ปุ่ม (ทักมาแล้วจะได้อะไร ฯลฯ)', 'checkbox' ),
