...
function ea2000_defaults() {
	...
	$d = array(
		...
		'links_fast_img'     => $img_assets . 'link-download-ea2000.png',
		'links_fast_url'     => '',
		'links_fast_alt'     => 'ดาวน์โหลด EA2000 สำหรับ MetaTrader 5',
		'links_feature_img'     => $img_assets . 'link-download-ea2000.png',
		'links_feature_url'     => '',
		...
		'links_guide5_url'   => '',
		'links_note'       => 'การเทรด Forex, Gold และ CFD มีความเสี่ยงสูง ผู้ใช้งานอาจขาดทุนได้ · EA2000 เป็นเครื่องมือช่วยเทรดตามเงื่อนไขที่กำหนด ไม่ใช่การรับประกันผลกำไร',
		...
		'pain_subtitle' => 'ปัญหาคลาสสิกที่นักเทรดส่วนใหญ่ต้องเจอ และเป็นเหตุผลที่ EA2000 ถูกสร้างขึ้นมา',
		...
		/* ภาพระบบ (เว้นว่าง = แสดงโครงรอใส่ภาพหน้าจอจริง) */
		'show_gallery'     => true,
		...
		/* ผลการทดสอบ (ค่าที่ขึ้นต้นด้วย "ระบุ" / "เช่น" = placeholder จะถูกซ่อนจนกว่าจะกรอกจริง) */
		'show_perf'         => true,
	...
	$d = array_merge(
		...
		array(
			...
			'install_intro'     => 'ทำตามขั้นตอนด้านล่างเพื่อเริ่มใช้งาน EA2000 หากติดขั้นตอนไหน ทีมงานพร้อมช่วยเหลือผ่าน LINE',
			...
			'rp_block1_text'   => 'การเทรด Forex, ทองคำ, CFD และสินทรัพย์ทางการเงินอื่น ๆ มีความเสี่ยงสูงต่อเงินทุนของคุณ ราคาอาจเคลื่อนไหวผันผวนรุนแรงในระยะเวลาสั้น โดยเฉพาะช่วงข่าวสำคัญ สภาพคล่องต่ำ หรือภาวะตลาดผิดปกติ คุณอาจสูญเสียเงินลงทุนบางส่วนหรือทั้งหมด จึงควรใช้เฉพาะเงินเย็นที่พร้อมรับความเสี่ยงได้เท่านั้น',
