...
function ea2000_defaults() {
	...
	$d = array_merge(
		...
		array(
			...
			'inst_step1_title'  => 'เปิดโฟลเดอร์ข้อมูลของ MT5',
			'inst_step1_desc'   => 'ที่โปรแกรม MetaTrader 5 คลิกเมนู File แล้วเลือก Open Data Folder หน้าต่างโฟลเดอร์ของบัญชีที่คุณเปิดอยู่จะเด้งขึ้นมา นี่คือที่เก็บไฟล์ของ MT5 ตัวนั้นโดยตรง',
			'inst_step1_img'    => $install_assets . 'guide-01.webp',
			'inst_step2_title'  => 'วางไฟล์ EA2000 ในโฟลเดอร์ Experts',
			'inst_step2_desc'   => 'เมื่อหน้าต่างโฟลเดอร์เปิดขึ้น ให้เข้า MQL5 แล้วเข้า Experts จากนั้นนำไฟล์ EA2000 ที่ได้รับมาวางไว้ในโฟลเดอร์นี้ ถ้าวางผิดตำแหน่ง MT5 จะมองไม่เห็น EA',
			'inst_step2_img'    => $install_assets . 'guide-02.webp',
			'inst_step3_title'  => 'กลับมาที่ MT5 แล้วหา EA2000 ใน Navigator',
			'inst_step3_desc'   => 'กลับมาที่โปรแกรม ดูหน้าต่าง Navigator ทางซ้าย แล้วกางหมวด Expert Advisors ถ้ายังไม่เห็นชื่อ EA2000 ให้คลิกขวาเลือก Refresh หรือปิดแล้วเปิด MT5 ใหม่อีกครั้ง',
			'inst_step3_img'    => $install_assets . 'guide-03.webp',
			'inst_step4_title'  => 'ลาก EA2000 ไปวางบนกราฟที่ต้องการ',
			'inst_step4_desc'   => 'เปิดกราฟคู่เงินที่จะใช้และตั้ง Timeframe ตามที่ทีมงานแนะนำ จากนั้นลาก EA2000 จากหน้าต่าง Navigator ไปวางบนกราฟนั้น หน้าต่างตั้งค่าจะเด้งขึ้นมาให้ทันที',
			'inst_step4_img'    => $install_assets . 'guide-04.webp',
			'inst_step5_title'  => 'เปิดสิทธิ์ให้ EA ทำงาน',
			...
			'inst_step2_img_alt'  => 'โฟลเดอร์ MQL5 แล้ว Experts ซึ่งเป็นตำแหน่งที่ต้องวางไฟล์ EA',
			'inst_step2_img_note' => 'รูปที่ต้องใส่: หน้าต่างโฟลเดอร์ที่เปิดถึง MQL5 > Experts',
			'inst_step3_img_alt'  => 'หน้าต่าง Navigator ใน MetaTrader 5 ที่กางหมวด Expert Advisors ไว้',
			'inst_step3_img_note' => 'รูปที่ต้องใส่: หน้าต่าง Navigator ที่กางหมวด Expert Advisors และเห็นชื่อ EA2000',
			'inst_step4_img_alt'  => 'กราฟใน MetaTrader 5 ที่ใช้ลาก EA ไปวาง',
