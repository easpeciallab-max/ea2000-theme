...
function ea2000_setup() {
	...
	/* ปิด Optimized Image Loading ของ Elementor ที่เติม fetchpriority/loading ซ้ำลงบน <img> ของธีม (ธีมใส่เองแล้ว) */
	add_filter( 'pre_option_elementor_optimized_image_loading', '__return_zero' );
	add_theme_support(
		'html5',
...
/**
 * Preload รูปกล่องสินค้าใน hero (LCP element ของหน้าแรกบนเดสก์ท็อป)
 * พิมพ์เฉพาะหน้าแรกที่เปิด hero และมี hero_image · ต้องตรงกับ src ของ <img> ใน front-page.php
 * เดสก์ท็อปเท่านั้น (min-width: 961px): ต่ำกว่านั้นกล่องสินค้าอยู่ใต้ fold ทั้งกล่อง LCP บนมือถือคือข้อความ จึงไม่ preload
 * และ <img> ไม่ใส่ fetchpriority เพื่อไม่ให้แย่งคิวกับฟอนต์
 */
...
function ea2000_defaults() {
	...
	$d = array(
		...
		'brand_wordmark'       => $img_assets . 'wordmark-660.webp', // โลโก้แนวนอน (เว้นว่าง = แสดงโลโก้กลม + ชื่อแบรนด์)
		...
		'links_title'      => 'EA2000',
		'links_tagline'    => 'ระบบเทรดอัตโนมัติบน MetaTrader 5 พร้อมคู่มือภาษาไทยและทีมงานไทยช่วยแนะนำการติดตั้ง',
		'links_badges'     => '',
		'links_logo'       => '',
		'links_signup_label' => 'เปิดบัญชี MT5',
		'links_signup_url'   => '',
		'links_account_guide_label' => 'สอนเปิดบัญชีทีละขั้น',
		'links_account_guide_url'   => '/open-mt5-account/',
		'links_mt5_download_label'  => 'วิธีล็อกอินเข้า Zaurix-Server',
		'links_mt5_download_url'    => '/mt5-login/',
		'links_signup_line_label' => 'ขอลิงก์เปิดบัญชีจากทีมงานทาง LINE',
		'links_help_title'          => 'ติดขั้นตอนไหน ทักทีมงานได้',
		'links_steps_title'         => 'เริ่มใช้งาน EA2000 ใน {n} ขั้นตอน',
		'links_step1_title'         => 'เปิดบัญชี MT5 กับ Zaurix',
		'links_step1_desc'          => 'สมัครและยืนยันตัวตน (KYC) เพื่อรับเลขบัญชีและรหัสผ่าน MT5',
		'links_step1_note'          => 'EA2000 เป็นพันธมิตรของ Zaurix และได้รับค่าตอบแทนเมื่อเปิดบัญชีผ่านลิงก์ของทีมงาน',
		'links_step1_badge'         => '',
		'links_mt5_install_title'   => 'ติดตั้งแอป MT5 และล็อกอิน',
		'links_step2_desc'          => 'เลือกอุปกรณ์ที่ใช้ แล้วล็อกอินด้วยบัญชีจากขั้นที่ 1',
		'links_step2_note'          => '',
		'links_step2_badge'         => '',
		'links_mt5_ios_label'       => 'iPhone',
		'links_mt5_ios_url'         => 'https://apps.apple.com/us/app/metatrader-5/id413251709',
		'links_mt5_android_label'   => 'Android',
		'links_mt5_android_url'     => 'https://play.google.com/store/apps/details?id=net.metaquotes.metatrader5',
		'links_mt5_windows_label'   => 'Windows',
		'links_mt5_windows_url'     => 'https://www.metatrader5.com/en/download',
		'links_mt5_macos_label'     => '',
		'links_mt5_macos_url'       => '',
		'links_step3_title'         => 'ฝากเงินเข้าบัญชีเทรด',
		'links_step3_desc'          => 'ฝากเงินผ่านหน้า Portal ของ Zaurix ก่อนเริ่มใช้ EA',
		'links_step3_note'          => '',
		'links_step3_badge'         => '',
		'links_deposit_label'       => 'เข้า Portal Zaurix',
		'links_deposit_url'         => 'https://portal.zaurix.com/',
		'links_deposit_guide_label' => 'คู่มือฝากเงิน',
		'links_deposit_guide_url'   => '',
		'links_step4_title'         => 'รับไฟล์ EA2000',
		'links_step4_desc'          => 'ทีมงานส่งไฟล์ EA2000 ให้ทาง LINE หลังยืนยันสิทธิ์การใช้งาน',
		'links_step4_note'          => '',
		'links_step4_badge'         => '',
		'links_download_line_label' => 'ขอรับไฟล์ EA2000 ทาง LINE',
		'links_step5_title'         => 'ติดตั้ง EA บน MT5',
		'links_step5_desc'          => 'วางไฟล์ EA ลงใน MT5 แล้วเปิด Algo Trading',
		'links_step5_note'          => '',
		'links_step5_badge'         => '',
		'links_step6_title'         => 'ให้ EA ทำงาน 24 ชั่วโมงด้วย VPS',
		'links_step6_desc'          => 'เลือกคู่มือ VPS ตามอุปกรณ์ที่ใช้',
		'links_step6_note'          => '',
		'links_step6_badge'         => 'แนะนำ',
		'links_info_title'          => 'ข้อมูลก่อนตัดสินใจ',
		'links_pending_label'       => 'เร็ว ๆ นี้',
		'links_show_doc'            => false,
		...
		'hero_desc'      => 'Expert Advisor สำหรับ MetaTrader 5 ใช้ได้กับหลายคู่เงิน ทอง และสินทรัพย์อื่นบน MT5 ทำงานตามกฎที่ตั้งไว้ล่วงหน้า ไม่ตัดสินใจตามอารมณ์ ทุนและความเสี่ยงคุณกำหนดเอง',
		'hero_btn1_text' => 'สอบถามทาง LINE',
		'hero_btn2_text' => 'EA2000 ทำงานอย่างไร',
		'hero_note'      => 'การเทรดอาจขาดทุนได้ทั้งหมด ผลในอดีตไม่บอกผลในอนาคต โปรดอ่านประกาศความเสี่ยงก่อนตัดสินใจ',
		...
		'what_text'     => "EA2000 คือ Expert Advisor หรือที่หลายคนเรียกว่าบอทเทรดและโรบอทเทรด สำหรับแพลตฟอร์ม MetaTrader 5 โปรแกรมติดตั้งบนกราฟ MT5 แล้วเฝ้าดูราคาแทนคุณตลอดเวลาที่ตลาดเปิด เมื่อราคาเข้าเงื่อนไขที่ตั้งไว้ล่วงหน้า ระบบจะเปิดออเดอร์ จัดการขนาดออเดอร์และเงื่อนไขปิดตามค่าที่ตั้งไว้ แล้วปิดเมื่อครบเงื่อนไข โดยไม่ต้องเฝ้าจอเอง\n\nEA2000 ใช้ได้กับหลายคู่เงิน ทอง และสินทรัพย์อื่นที่มีบนบัญชี MT5 ของโบรกเกอร์ที่คุณเลือก คุณกำหนดทุนและระดับความเสี่ยงเอง หยุดระบบได้ทุกเมื่อ สิ่งที่ระบบทำให้คือความสม่ำเสมอ: ทำตามกฎเดิมทุกครั้ง ไม่รีบเข้า ไม่ลังเลตอนควรออก EA ไม่ใช่เครื่องมือการันตีกำไร ผลลัพธ์ขึ้นกับตลาดและการตั้งค่าของคุณ",
		...
		'how_step4_desc'  => 'แผง Dashboard บนกราฟแสดงทุน กำไรขาดทุน Drawdown และสถานะออเดอร์แบบเรียลไทม์ ส่วนยอดเงินและออเดอร์เปิดดูในแอป MT5 บนมือถือได้ แผง Dashboard ดูผ่านหน้าจอของ VPS หรือคอมพิวเตอร์ที่รัน EA และสอบถามทีมงานทาง LINE ได้เมื่อมีคำถาม',
		...
		'features_subtitle' => 'หกส่วนที่ทำให้การเทรดของคุณมีขั้นตอนชัด ตรวจย้อนหลังได้ และให้คุณเป็นคนกำหนดระดับความเสี่ยงเอง',
		'feat1_title'       => 'ส่งคำสั่งตามกฎที่ตั้งไว้',
		'feat1_desc'        => 'เปิดและปิดออเดอร์เมื่อเงื่อนไขครบตามที่กำหนด ไม่มีการเดาและไม่เปลี่ยนใจกลางทาง',
		'feat2_title'       => 'สร้างสำหรับ MT5 โดยตรง',
		'feat2_desc'        => 'เขียนด้วย MQL5 ติดตั้งบน MetaTrader 5 ได้ทั้งบัญชี Demo และบัญชีจริง',
		'feat3_title'       => 'แผงสถานะบนกราฟ',
		'feat3_desc'        => 'เห็นสถานะการทำงาน ออเดอร์ที่เปิดอยู่ และผลรวมของบัญชีในแผงเดียวบนหน้าจอ MT5',
		'feat4_title'       => 'ขอบเขตความเสี่ยงที่คุณกำหนด',
		'feat4_desc'        => 'วางแผนขนาดออเดอร์และระดับ Drawdown ที่ยอมรับได้ ให้เหมาะกับทุนของคุณ',
		'feat5_title'       => 'ทำงานขณะคุณไม่อยู่หน้าจอ',
		'feat5_desc'        => 'เมื่อ MT5 หรือ VPS เปิดอยู่ ระบบเดินตามแผนต่อได้แม้คุณอยู่ที่ทำงานหรือกำลังพัก',
		'feat6_title'       => 'ทีมช่วยตั้งค่าตั้งแต่ครั้งแรก',
		'feat6_desc'        => 'มีคนแนะนำตั้งแต่ติดตั้งจนตั้งค่าเสร็จผ่าน LINE ไม่ต้องเริ่มจากศูนย์',
		...
		'tests_bt_img'      => '',
		'tests_bt_img_alt'  => 'ภาพประกอบวิธีตั้งค่า Strategy Tester ของ MetaTrader 5 ที่แท็บ Settings: ช่อง Expert เลือก EA ที่ต้องการทดสอบ Symbol กับ Timeframe ตามคู่มือของ EA ช่วงวันที่ย้อนหลังอย่างน้อย 1 ถึง 2 ปี Delays แบบ Random delay Modelling แบบ Every tick based on real ticks และ Deposit กับ Leverage เท่ากับบัญชีที่จะใช้จริง พร้อมรายการค่าที่ควรอ่านหลังทดสอบ ไม่มีผลทดสอบจริง',
		...
		'tests_bt_img_caption' => 'ภาพประกอบวิธีตั้งค่า ไม่ใช่ผลการทดสอบของ EA2000',
		'tests_bt_img_mobile' => '',
		...
		'tests_fw_img'      => '',
		'tests_fw_img_alt'  => 'ภาพประกอบวิธีอ่านหน้ารายงาน Forward Test ไม่มีตัวเลขจริง: ช่อง Drawdown สูงสุด Gain จำนวนออเดอร์ และระยะเวลาที่รันเว้นว่างไว้ กราฟที่เส้น Balance ขยับเป็นขั้นเฉพาะตอนปิดออเดอร์ ส่วนเส้น Equity ดิ่งต่ำกว่า Balance ช่วงข่าวแรง พร้อมวงเล็บบอก Drawdown สูงสุด และรายการสิ่งที่ควรเช็กก่อนเชื่อรายงาน',
		...
		'tests_fw_img_caption' => 'ภาพประกอบวิธีอ่านรายงาน ไม่ใช่ผล Forward Test ของ EA2000',
		'tests_fw_img_mobile' => '',
		'tests_note'        => 'EA2000 ยังไม่มีผลทดสอบที่เผยแพร่ ผลในอดีตไม่รับประกันผลในอนาคต',
		...
		'pricing_btn_text'  => 'เลือกแพ็กเกจนี้ผ่าน LINE',
		'pricing_note'      => 'ตัวเลขข้างต้นคือราคาแพ็กเกจ ไม่ใช่ผลการเทรด เงื่อนไขล่าสุดและความเหมาะสมกับบัญชีของคุณสอบถามได้ทาง LINE',
		...
		'pkg1_name'        => 'Starter',
		'pkg1_tag'         => 'จุดเริ่มต้น ถามก่อน ยังไม่ต้องตัดสินใจ',
		'pkg1_price'       => 'Free',
		'pkg1_period'      => 'สอบถามทีมงาน',
		'pkg1_features'    => "คุยกับทีมว่าระบบเหมาะกับทุนและเวลาของคุณไหม\nเห็นภาพรวมการทำงานและค่าตั้งต้นที่ใช้\nแนะนำเรื่องเงินทุน โบรกเกอร์ และชนิดบัญชี MT5\nถามตอบได้ทาง LINE Official Account",
		'pkg1_featured'    => false,
		'pkg2_name'        => 'Pro',
		'pkg2_tag'         => 'สำหรับรันบนบัญชีจริงอย่างต่อเนื่อง',
		'pkg2_price'       => '6,990',
		'pkg2_period'      => 'บาท',
		'pkg2_features'    => "สิทธิ์ใช้ EA2000 กับบัญชี MT5 ของคุณ\nคู่มือติดตั้งและตั้งค่าแบบทำตามทีละขั้น\nไฟล์ Preset แยกตามระดับความเสี่ยงพร้อมคำอธิบาย\nได้รับเวอร์ชันใหม่เมื่อมีการอัปเดต\nติดต่อทีมงานผ่าน LINE Official Account",
		'pkg2_featured'    => true,
		'pkg3_name'        => 'VIP',
		'pkg3_tag'         => 'สำหรับผู้ที่ต้องการให้ทีมดูแลตลอดการใช้งาน',
		'pkg3_price'       => '9,990',
		'pkg3_period'      => 'บาท',
		'pkg3_features'    => "ทุกอย่างใน Pro\nทีมงานติดตั้งให้บนคอมพิวเตอร์หรือ VPS ของคุณ\nตรวจค่าที่ตั้งไว้ร่วมกันก่อนเปิดใช้งานจริง\nวางกรอบความเสี่ยงให้สอดคล้องกับทุนของคุณ\nดูแลต่อเนื่องผ่าน LINE Official Account",
		'pkg3_featured'    => false,
		...
		'faq4_q'       => 'EA2000 เทรดคู่เงินอะไรบ้าง เทรดทองได้ไหม',
		'faq4_a'       => 'EA2000 ออกแบบให้ใช้กับหลายสินทรัพย์บน MT5 ทั้งคู่เงิน ทอง และสินทรัพย์อื่น ไม่ผูกกับสินทรัพย์ใดสินทรัพย์หนึ่ง คู่เงินที่แนะนำและค่าที่เหมาะกับแต่ละคู่อยู่ในไฟล์ Preset และคู่มือตามแพ็กเกจ ควรเริ่มจากคู่ที่ Spread ต่ำและทดสอบบนบัญชีเดโมก่อน',
		...
		'footer_prep_text'     => 'ตอบสี่ข้อนี้ในข้อความแรก ทีมจะตอบได้ตรงและเร็วขึ้น',
		'footer_prep_items'    => "ทุนโดยประมาณที่จะใช้กับบัญชีนี้\nโบรกเกอร์ที่ใช้และชนิดบัญชี MT5\nต้องการอะไร: ติดตั้ง / ราคา / ประเมินว่าเหมาะไหม\nเวลาที่สะดวกให้ตอบกลับ",
	...
	$d = array_merge(
		...
		array(
			...
			'backtest_img_caption'=> 'ภาพประกอบวิธีตั้งค่า ไม่ใช่ผลการทดสอบของ EA2000',
			'backtest_img_alt'    => 'ภาพประกอบวิธีตั้งค่า Strategy Tester ของ MetaTrader 5 ที่แท็บ Settings: ช่อง Expert เลือก EA ที่ต้องการทดสอบ Symbol กับ Timeframe ตามคู่มือของ EA ช่วงวันที่ย้อนหลังอย่างน้อย 1 ถึง 2 ปี Delays แบบ Random delay Modelling แบบ Every tick based on real ticks และ Deposit กับ Leverage เท่ากับบัญชีที่จะใช้จริง พร้อมรายการค่าที่ควรอ่านหลังทดสอบ ไม่มีผลทดสอบจริง',
			'backtest_img_note'   => '',
			...
			'forward_img_caption'=> 'ภาพประกอบวิธีอ่านรายงาน ไม่ใช่ผล Forward Test ของ EA2000',
			'forward_img_alt'    => 'ภาพประกอบวิธีอ่านหน้ารายงาน Forward Test ไม่มีตัวเลขจริง: ช่อง Drawdown สูงสุด Gain จำนวนออเดอร์ และระยะเวลาที่รันเว้นว่างไว้ กราฟที่เส้น Balance ขยับเป็นขั้นเฉพาะตอนปิดออเดอร์ ส่วนเส้น Equity ดิ่งต่ำกว่า Balance ช่วงข่าวแรง พร้อมวงเล็บบอก Drawdown สูงสุด และรายการสิ่งที่ควรเช็กก่อนเชื่อรายงาน',
			'forward_img_note'   => '',
			'forward_link_label' => '',
			'forward_link_url'   => '',
			...
			'install_sub'       => 'คู่มือติดตั้ง EA2000 บน MetaTrader 5 ทีละขั้น พร้อมภาพประกอบทุกขั้นตอน',
			...
			'inst_step1_title'  => 'ติดตั้ง MetaTrader 5 และเตรียม VPS',
			'inst_step1_desc'   => 'ดาวน์โหลดและติดตั้ง MetaTrader 5 จากโบรกเกอร์ของคุณ แล้วล็อกอินเข้าบัญชีให้เรียบร้อยก่อน ถ้าต้องการให้ระบบทำงานต่อเนื่องโดยไม่ต้องเปิดคอมพิวเตอร์ทิ้งไว้ ให้เช่า VPS แล้วติดตั้ง MT5 บน VPS นั้นแทน วิธีเชื่อมต่ออยู่ในคู่มือการใช้งาน VPS',
			'inst_step1_img'    => '',
			'inst_step2_title'  => 'เปิดโฟลเดอร์ Experts แล้วนำไฟล์ EA เข้า',
			'inst_step2_desc'   => 'ใน MT5 ไปที่เมนู File แล้วเลือก Open Data Folder จากนั้นเข้าโฟลเดอร์ MQL5 แล้วเข้า Experts นำไฟล์ EA2000 ที่ได้รับมาวางไว้ในโฟลเดอร์นี้ ถ้าวางผิดตำแหน่ง MT5 จะมองไม่เห็น EA',
			'inst_step2_img'    => '',
			'inst_step3_title'  => 'ลาก EA ขึ้นกราฟ และตั้งค่า',
			'inst_step3_desc'   => 'กลับมาที่ MT5 แล้วปิดเปิดโปรแกรมใหม่หนึ่งครั้งเพื่อให้ EA ขึ้นใน Navigator เปิดกราฟที่จะใช้ แล้วลาก EA2000 จากหน้าต่าง Navigator ไปวางบนกราฟ หน้าต่างตั้งค่าจะเด้งขึ้นมาให้ตั้ง Lot และระดับความเสี่ยงตามทุนของคุณ ถ้าได้รับไฟล์ Preset มาให้กด Load แล้วเลือกไฟล์นั้นแทน',
			'inst_step3_img'    => '',
			'inst_step4_title'  => 'เปิด AutoTrading',
			'inst_step4_desc'   => 'กดปุ่ม AutoTrading หรือ Algo Trading บนแถบเครื่องมือให้เป็นสีเขียว แล้วดูมุมขวาบนของกราฟว่ามีชื่อ EA2000 และไอคอนสถานะของ EA หน้าตาไอคอนต่างกันตามเวอร์ชันของ MT5 ถ้าไอคอนบอกว่ายังไม่ได้รับอนุญาตให้เทรด แปลว่า EA ติดอยู่บนกราฟแล้วแต่ยังส่งคำสั่งไม่ได้ ดูสาเหตุได้จากข้อความในแท็บ Experts',
			'inst_step4_img'    => '',
			'inst_step5_title'  => 'ตรวจสอบการทำงานผ่าน Dashboard',
			'inst_step5_desc'   => 'แผง Dashboard บนกราฟจะบอกสถานะระบบ สัญลักษณ์และ Timeframe ที่ใช้อยู่ ทุนในบัญชี และจำนวนออเดอร์ที่เปิดอยู่ ให้ดูควบคู่กับแท็บ Experts และ Journal ด้านล่างของโปรแกรมว่าไม่มีข้อความแจ้งเตือนสีแดง',
			'inst_step5_img'    => '',
			'inst_step6_title'  => 'ปรับความเสี่ยงให้เหมาะกับตัวเอง',
			'inst_step6_desc'   => 'ทบทวนการตั้งค่าความเสี่ยงเป็นระยะ ใช้เงินเย็นที่ยอมรับได้ว่าอาจสูญไปทั้งหมด และปรับ Lot ให้สอดคล้องกับทุนที่มีจริง เพื่อให้ Drawdown อยู่ในระดับที่คุณรับได้ ถ้าไม่แน่ใจว่าควรตั้งเท่าไร ทักทีมงานพร้อมบอกทุนที่จะใช้ จะแนะนำให้ได้ตรงกว่า',
			'inst_step6_img'    => '',
			'inst_step1_img_alt'  => 'ตัวติดตั้ง MetaTrader 5 บนหน้าจอ Windows คู่กับหน้าต่าง Remote Desktop ที่ต่อเข้า VPS',
			'inst_step1_img_note' => '',
			'inst_step1_img_caption' => '',
			'inst_step2_img_alt'  => 'เมนู File ของ MT5 ที่เลือก Open Data Folder และหน้าต่างโฟลเดอร์ MQL5 แล้ว Experts ที่มีไฟล์ EA2000 วางอยู่',
			'inst_step2_img_note' => '',
			'inst_step2_img_caption' => '',
			'inst_step3_img_alt'  => 'หน้าต่าง Navigator ที่มี EA2000 อยู่ใต้ Expert Advisors และหน้าต่างตั้งค่าที่เปิดแท็บ Inputs',
			'inst_step3_img_note' => '',
			'inst_step3_img_caption' => 'ค่าที่เห็นในภาพเป็นตัวอย่างเพื่อให้เห็นหน้าตาหน้าต่างตั้งค่า ค่าจริงทีมงานแนะนำตามทุนของคุณ',
			'inst_step4_img_alt'  => 'ปุ่ม Algo Trading สีเขียวบนแถบเครื่องมือ MT5 และไอคอนสถานะของ EA ที่มุมขวาบนของกราฟ',
			'inst_step4_img_note' => '',
			'inst_step4_img_caption' => '',
			'inst_step5_img_alt'  => 'แผง Dashboard ของ EA2000 บนกราฟ แสดงสถานะ สัญลักษณ์ ทุน และจำนวนออเดอร์ พร้อมแท็บ Experts ด้านล่าง',
			'inst_step5_img_note' => '',
			'inst_step5_img_caption' => 'ตัวเลขในภาพเป็นตัวอย่างเพื่อให้เห็นหน้าตาของแผง ไม่ใช่ผลการเทรดจริง',
			'inst_step6_img_alt'  => 'หน้าต่างตั้งค่า EA2000 แท็บ Inputs พร้อมตารางแนวทางการตั้งความเสี่ยงสามระดับ',
			'inst_step6_img_note' => '',
			'inst_step6_img_caption' => 'ค่าและตารางในภาพเป็นแนวทางตัวอย่าง ไม่ใช่การรับประกันผล',
			'install_cta_title' => 'ติดขั้นตอนไหน ทักทีมงานได้',
			'install_cta_text'  => 'ทีมงานแนะนำให้ทีละขั้นทาง LINE ส่วนแพ็กเกจ VIP ทีมงานติดตั้งให้ถึงเครื่องหรือ VPS',
			'install_note'      => 'ติดขั้นตอนไหน ทักทีมงานทาง LINE ได้ ทีมงานแนะนำให้ทีละขั้น ส่วนแพ็กเกจ VIP ทีมงานติดตั้งให้ถึงเครื่องหรือ VPS',

			/* หน้า Pricing (เพิ่มเติม) */
			'pricing_sub'   => 'เลือกแพ็กเกจที่เหมาะกับการใช้งานของคุณ',
			'compare_title' => 'ตารางเปรียบเทียบแพ็กเกจ',
			'compare_rows'  => "รายการ | Starter | Pro | VIP\nจำนวนบัญชีที่ใช้ได้ | ✗ | 1 ถึง 2 | ตามตกลง\nไฟล์ Preset ตั้งค่าพร้อมใช้ | ✗ | ✓ | ✓\nทีมงานติดตั้งให้ถึงเครื่องหรือ VPS | ✗ | ✗ | ✓\nอัปเดตระบบ | ✗ | ✓ | ✓\nระดับการ Support | พื้นฐาน | ส่วนตัว | ใกล้ชิด",

			/* หน้า Risk Disclosure */
			'riskpage_sub'     => 'ข้อมูลความเสี่ยงที่ควรอ่านก่อนเริ่มใช้งาน',
			'riskpage_intro'   => 'หน้านี้รวบรวมความเสี่ยงที่คุณควรรู้ก่อนเริ่มใช้ EA2000 หรือเทรดในตลาดใดก็ตาม ทั้งความเสี่ยงของตลาดเอง ข้อจำกัดของระบบอัตโนมัติ และสิ่งที่ผู้ใช้ต้องรับผิดชอบเอง กรุณาอ่านให้ครบก่อนตัดสินใจ',
			'riskpage_image'   => '',
			'riskpage_image_caption' => 'ตัวอย่างแนวทางตั้งค่าความเสี่ยงและ Lot Size ให้เหมาะสมกับทุน',
			'rp_block1_title'  => 'เงินทุนของคุณมีความเสี่ยง',
			'rp_block1_text'   => 'Forex, CFD และสินทรัพย์ทางการเงินอื่น ๆ รวมถึงทองคำ เป็นตลาดที่มีความเสี่ยงสูง ราคาเปลี่ยนเร็วและแรงได้ในเวลาไม่กี่นาที โดยเฉพาะช่วงประกาศข่าว ช่วงสภาพคล่องบาง หรือเมื่อตลาดผิดปกติ การขาดทุนอาจเกิดกับเงินทุนบางส่วนหรือทั้งหมด ใช้เฉพาะเงินที่เสียได้โดยไม่กระทบชีวิตประจำวันเท่านั้น',
			'rp_block2_title'  => 'EA2000 ไม่รับประกันผลกำไร',
			'rp_block2_text'   => 'EA2000 ทำงานตามกฎที่กำหนดไว้ล่วงหน้า ซึ่งไม่ได้แปลว่าจะได้กำไรทุกวันหรือทุกเดือน และไม่มีกฎชุดใดกันการขาดทุนได้ในทุกสภาพตลาด ผลที่เกิดขึ้นจริงขึ้นกับตลาด ค่าที่ตั้ง ขนาดทุน ระดับความเสี่ยงที่เลือก รวมถึง Spread, Commission, Slippage และเงื่อนไขของโบรกเกอร์แต่ละราย',
			'rp_block3_title'  => 'ผลทดสอบในอดีตไม่ใช่คำทำนายอนาคต',
			'rp_block3_text'   => 'ผล Backtest คือการจำลองกับราคาในอดีต ส่วนผล Forward Test คือผลในช่วงเวลาหนึ่งบนบัญชีเดโมหรือบัญชีจริง ทั้งสองแบบบอกได้เพียงว่าระบบทำงานอย่างไรภายใต้เงื่อนไขและช่วงเวลานั้น ไม่ได้บอกว่าอนาคตจะออกมาเหมือนเดิม ตลาดเปลี่ยนสภาพได้เสมอ และระบบที่เคยให้ผลดีอาจให้ผลต่างไปอย่างมาก',
			'rp_block4_title'  => 'ผู้ใช้เป็นผู้ตัดสินใจและรับผิดชอบเอง',
			'rp_block4_text'   => 'คุณเป็นผู้เลือกโบรกเกอร์ ชนิดบัญชี ขนาด Lot และระดับความเสี่ยง และเป็นผู้เปิดหรือปิดระบบบนบัญชีของตัวเอง ผลที่ตามมาจากการตัดสินใจเหล่านี้เป็นความรับผิดชอบของผู้ใช้ ก่อนใช้กับเงินจริง ควรทดลองบนบัญชีเดโมหรือทุนน้อย ตั้งค่าอย่างระมัดระวัง และทำความเข้าใจผลของแต่ละค่าที่ปรับให้ชัดเจน',
			'rp_block5_title'  => 'เนื้อหาบนเว็บไซต์ไม่ใช่คำแนะนำการลงทุน',
			'rp_block5_text'   => 'ทุกข้อความบนเว็บไซต์นี้มีไว้อธิบายเครื่องมือและวิธีใช้งาน ไม่ใช่คำแนะนำด้านการเงิน การลงทุน กฎหมาย หรือภาษี และทีมงานไม่ได้เป็นที่ปรึกษาการลงทุนของผู้ใช้รายใด หากต้องการคำแนะนำที่เหมาะกับสถานการณ์ของคุณ ควรปรึกษาผู้ประกอบวิชาชีพที่มีใบอนุญาตตามกฎหมาย',
			'rp_block6_title'  => 'ความเสี่ยงจากระบบและการเชื่อมต่อ',
			'rp_block6_text'   => 'EA ทำงานได้ต่อเมื่อ MetaTrader 5 เปิดอยู่บนคอมพิวเตอร์หรือ VPS ที่เชื่อมต่ออินเทอร์เน็ต และเซิร์ฟเวอร์ของโบรกเกอร์รับคำสั่งได้ตามปกติ เหตุขัดข้อง เช่น เน็ตหลุด VPS ดับ โปรแกรมค้าง คำสั่งถูกปฏิเสธ หรือโบรกเกอร์จำกัดการเทรด อาจทำให้ระบบไม่ทำงานตามที่ตั้งไว้และกระทบผลการเทรด ควรตรวจสถานะระบบเป็นระยะและเตรียมแผนรับมือไว้ล่วงหน้า',
			'riskpage_updated' => 'ปรับปรุงล่าสุด: 11 กันยายน 2569',
		)
	);
	...
	if ( function_exists( 'ea2000_page_content_defaults' ) ) {
...
function ea2000_icon( $name, $class = 'icon' ) {
	$svg = array(
		...
		/* ขวดทดลอง · ใช้กับคำว่าการทดสอบ แทนกราฟพุ่งขึ้นที่ดูเหมือนผลกำไร */
		'flask'    => '<path d="M9 3h6"/><path d="M10.2 3v6.4L4.9 18.2A1.9 1.9 0 0 0 6.5 21h11a1.9 1.9 0 0 0 1.6-2.8L13.8 9.4V3"/><path d="M7.4 15.5h9.2"/>',
 ...
 * GET /wp-json/ea2000/v1/authcheck · เฉพาะผู้ดูแล (manage_options)
 * ผู้ที่ไม่ได้ยืนยันตัวตนจะได้ 401 ซึ่งก็บอกได้เองว่า header ไม่มาถึงหรือรหัสไม่ถูก
 */
function ea2000_register_authcheck_route() {
	register_rest_route(
		...
		array(
			'methods'             => 'GET',
			'permission_callback' => 'ea2000_authcheck_permission',
...
function ea2000_authcheck_permission() {
...
/* WordPress เติม global-styles กลับเข้าคิวที่ wp_footer ลำดับ 1 (wp_enqueue_global_styles) · ถอดอีกครั้งก่อนพิมพ์สคริปต์ท้ายหน้า */
add_action( 'wp_footer', 'ea2000_trim_front_assets', 2 );
