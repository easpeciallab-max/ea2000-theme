...
function ea2000_defaults() {
	...
	$d = array_merge(
		...
		array(
			...
			'inst_step4_desc'   => 'กดปุ่ม AutoTrading หรือ Algo Trading บนแถบเครื่องมือให้เป็นสีเขียว แล้วดูมุมขวาบนของกราฟว่ามีชื่อ EA2000 พร้อมไอคอนหน้ายิ้ม ถ้าขึ้นเป็นหน้าเศร้าหรือกากบาท แปลว่า EA ติดอยู่บนกราฟแล้วแต่ยังส่งคำสั่งไม่ได้',
			'inst_step4_img'    => '',
			...
			'inst_step4_img_alt'  => 'ปุ่ม Algo Trading สีเขียวบนแถบเครื่องมือ MT5 และไอคอนหน้ายิ้มที่มุมขวาบนของกราฟ',
			'inst_step4_img_note' => '',
