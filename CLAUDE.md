...
- **ยังไม่ได้ยืนยันว่า QR นี้ชี้ไปที่ LINE OA เดียวกับ `line_url` (`https://lin.ee/ye11pwm6`) หรือไม่** ถอดรหัส QR ไม่ได้ในเครื่องมือที่มี ถ้าเป็นคนละบัญชีให้เจ้าของแจ้งเพื่อแก้ให้ตรงกัน
